...
const ComplianceStandardForm = ({ standardId, onSave, onCancel }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    regulationNumber: Yup.string()
      ...
      .matches(
        ...
        intl.formatMessage({
          ...
          defaultMessage:
            "Regulation number can only contain letters, numbers, hyphens, and slashes",
        }),
      ),
    ...
    applicableSampleTypes: Yup.array().min(
      1,
      intl.formatMessage({
    ...
    enforcementAuthority: Yup.string().max(
      255,
      intl.formatMessage({
  ...
  const statusOptions = [
    {
      ...
      label: intl.formatMessage({
        id: "compliance.standard.status.draft",
    ...
    },
    {
      value: "ACTIVE",
      label: intl.formatMessage({
        id: "compliance.standard.status.active",
    ...
    },
    {
      value: "SUSPENDED",
      label: intl.formatMessage({
        id: "compliance.standard.status.suspended",
        ...
        if (response) {
          ...
          addNotification({
            ...
            message: intl.formatMessage({
              ...
              defaultMessage:
                "Failed to load compliance standard. Please try again.",
            }),
          });
          setLoading(false);
        }
  ...
  const checkForDuplicates = (values, callback) => {
    ...
    postToOpenElisServer(
      "/rest/compliance/standards/check-duplicate",
        ...
        if (status === 200 || status === 201) {
          addNotification({
            ...
            message: intl.formatMessage({
              ...
              defaultMessage:
                "Compliance standard has been saved successfully.",
            }),
          });
          ...
          addNotification({
            ...
            message:
              ...
              intl.formatMessage({
                ...
                defaultMessage:
                  "Failed to save compliance standard. Please check the form and try again.",
              }),
          });
        }
      });
        ...
        <PageBreadCrumb
          breadcrumbs={[
            ...
            },
            {
              label: isEditing
                ? intl.formatMessage({
                    id: "compliance.standard.edit.breadcrumb",
                    defaultMessage: "Edit Standard",
                  })
                : intl.formatMessage({
                    id: "compliance.standard.create.breadcrumb",
                    defaultMessage: "Create Standard",
                  }),
            },
          ]}
        />
      ...
      <Column lg={16} className="compliance-standard-form__header">
        <h1>
          <FormattedMessage
            id={
              isEditing
                ? "compliance.standard.edit.title"
                : "compliance.standard.create.title"
            }
            defaultMessage={
              isEditing
                ...
                <Grid>
                  ...
                  <Column lg={8}>
                    <TextInput
                      ...
                      placeholder={intl.formatMessage({
                        ...
                        defaultMessage:
                          "Enter the full name of the compliance standard",
                      })}
                      maxLength={255}
                    />
                  </Column>
                  ...
                  <Column lg={8}>
                    <Select
                      ...
                      onChange={(e) =>
                        setFieldValue("issuingBody", e.target.value)
                      }
                  ...
                  <Column lg={8}>
                    <TextInput
                      ...
                      onBlur={handleBlur}
                      invalid={
                        touched.regulationNumber && errors.regulationNumber
                      }
                  ...
                  <Column lg={8}>
                    <DatePicker
                      dateFormat="m/d/Y"
                      onChange={(dates) =>
                        setFieldValue("effectiveDate", dates[0])
                      }
                  ...
                  <Column lg={8}>
                    <DatePicker
                      dateFormat="m/d/Y"
                      onChange={(dates) =>
                        setFieldValue("expiryDate", dates[0] || "")
                      }
                  ...
                  <Column lg={8}>
                    <Select
                      ...
                      onChange={(e) =>
                        setFieldValue("countryRegion", e.target.value)
                      }
                  ...
                  <Column lg={16}>
                    <TextArea
                      ...
                      placeholder={intl.formatMessage({
                        ...
                        defaultMessage:
                          "Provide a brief description of this compliance standard",
                      })}
                      rows={4}
                      maxCount={1000}
                    />
                  ...
                  <Column lg={8}>
                    <TextInput
                      ...
                      onBlur={handleBlur}
                      invalid={
                        touched.enforcementAuthority &&
                        errors.enforcementAuthority
                      }
                    ...
                    <div className="compliance-standard-form__sample-types">
                      {sampleTypes.map((sampleType) => (
                        <Tag
                          ...
                          type={
                            values.applicableSampleTypes.includes(
                              sampleType.value,
                            )
                              ? "blue"
                              : "outline"
