 ...
 * - Declares @Transactional boundaries at service level
 * - Provides business logic validation methods
 * - Supports all-or-nothing import semantics
 * - Includes security validation patterns
 */
public interface CSVImportService {
     ...
     *
     * @return Array of import statistics [total imports, successful, failed, pending]
     */
